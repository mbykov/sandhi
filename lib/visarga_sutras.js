...
var sutras = {
    ...
    'visarga-ah-a': {
        ...
        del: function(mark) {
            ...
            first = [first, Const.visarga].join('');
    ...
    'visarga-hard-cons': {
        ...
        del: function(mark) {
            first = [mark.first, Const.visarga].join('');
            return {firsts: [first], seconds: [mark.second]};
        },

        add: function(mark) {
            if (u.c(Const.cC, mark.beg)) {
                mark.first.push('श्');
            } else if (u.c(Const.wW, mark.beg)) {
                mark.first.push('ष्');
            } else if (u.c(Const.tT, mark.beg)) {
                mark.first.push('स्');
            } else if (mark.beg == 'श') {
                mark.first.push('श्');
            } else if (mark.beg == 'ष') {
    ...
    'visarga-r': {
        ...
        add: function(mark) {
            mark.first.push('र');
            if (!u.c(Const.allvowels, mark.beg)) mark.vir = true;
            return [mark];
        }
    },
