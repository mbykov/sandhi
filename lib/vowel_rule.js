...
rules.s6_1_78 = {
    ...
    method: function(test) {
        ...
        test.second.shift();
        log('=====METHOD 78====');
        return test.first.concat(semivow, Const.vow2liga[test.starts], test.second).join('');
    }
}
...
rules.s6_1_78_ext = {
    ...
    method: function(test) {
        ...
        test.second.shift();
        var res2 = test.first.concat(semivow, Const.vow2liga[test.starts], test.second).join('');
        // log('R1', res1, 'R2', res2);
        return [res1, res2];
    }
}
