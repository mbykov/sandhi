...
var sutras = [
    ...
    {num: '8.4.45',
     ...
     reverse: 'nasal FIXME: OR SOFT FIXME: when followed by n or m become the four final stops (k t ṭ p)',
     split: function(mark) {
         // if (!u.c(Const.nasals, mark.fin) || !u.c(Const.nasals, mark.beg)) return;
