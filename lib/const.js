...
Const.dirgha = shiva('अक्').dirgha().result;
Const.dirgha_ligas = shiva('अक्').dirgha().liga().result;
...
Const.Jay = shiva('झय्').result; // cons. hard+soft
Const.Nay = shiva('ञय्').result; // cons. nas + hard+soft
...
Const.cay = shiva('चय्').result; // 1st class +ss , hard unaspirated [ 'च', 'ट', 'त', 'क', 'प', 'श', 'ष', 'स' ]
Const.hal = shiva('हल्').result; // all consonants
// ===================
Const.way = shiva('टय्').result; // ट,त,क,प - k t ṭ p - 1st class ex. c
Const.mam = shiva('मम्').result; // म ङ ण न - 5st class ex. N
Const.baS = shiva('बश्').result; // ब ग ड द श्
Const.nasals = shiva('ञम्').result; // ञ म ङ ण न म्
Const.nm = ['न', 'म'];
// Const.nasal_nm = shiva('मम्').shiva(['न', 'म']).result;
// Const.finalhard_nm = shiva('टय्').shiva(['न', 'म']).result;
