...
Const.guna_diphs = shiva('एङ्').end();
Const.vriddhi_diphs = shiva('ऐच्').end();
...
// Const.simpleligas = shiva('इक्').add(shiva('इक्').dirgha()).end(); // iurl+long
...
// vow, liga, dirgha, dl, semivow, guna, gl, vriddhi, vl
Const.vowtable = [
    '-अ-आा',
    'यइिईीएेऐै',
    'वउुऊूओोऔौ',
