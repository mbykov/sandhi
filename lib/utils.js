...
utils.prototype.similar = function(a, b) {
    // log('A', a, 'B', b, 'D', Const.dirgha[a], Const.dirgha[b]);
    return ((Const.dirgha[a] && Const.dirgha[a] == Const.dirgha[b]) || ((isIN(Const.consonants, a)) && Const.dirgha[b] == 'ा')) ? true : false;
}
...
utils.prototype.matra = function(v) {
    return Const.vowels[Const.ligas.indexOf(v)];
}
