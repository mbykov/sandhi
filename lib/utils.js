...
utils.prototype.similar = function(a, b) {
    // log('A', a, this.dirgha(a));
    // log('B', b, this.dirgha(b));
    // log('SHIVA a', a, shiva([a]).dirgha().end());
    // log('SHIVA b', b, shiva([b]).dirgha().end());
...
// FIXME: переделать в новом стиле, как в .liga()
