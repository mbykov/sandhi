...
utils.prototype.combinator = function(arr) {
    var fn = function(active, rest, a) {
        ...
        var sects = active.map(function(m) {  return _.range(m.pos, (m.pos+m.pattern.length+0))}); // +2 - якобы проверка на слог между маркерами - пока тесты на 2 слова - не влияет
